...
@Component({
  selector: 'app-resumemade',
  templateUrl: './resumemade.component.html',
  styleUrls: ['./resumemade.component.css']
})
export class ResumemadeComponent {
  resume = new Resume();

  degrees = ['B.E.', 'M.E.', 'B.Com', 'M.Com'];

  constructor(private scriptService: ScriptService) {
    const resumeString = sessionStorage.getItem('resume');
